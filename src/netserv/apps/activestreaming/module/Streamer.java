...
class Streamer {
	...
	public Streamer(long length, InputStream inputStream, String fileName,
			boolean attachment, HttpServletRequest request,
	...
	public void stream() {
		...
		if (first != null && last != null) {
			...
			response.addHeader("Content-Range", "bytes " + first + "-" + last
					+ "/" + length);
