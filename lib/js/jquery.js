...
(function() {
	...
	(function() {
		...
		F.filter= function(ad,ac,ag,W) {
			...
			while(ad&&ac.length) {
				...
				if(ad==V) {
					if(T==null) {throw"Syntax error, unrecognized expression: "+ad
					} else {
						break
					}
				}
	...
	if(document.documentElement.getBoundingClientRect) {
		...
		o.fn.offset= function() {
			...
			while((J=J.parentNode)&&J!==K&&J!==H) {
				M=L.getComputedStyle(J,null);N-=J.scrollTop,I-=J.scrollLeft;
	...
	o.offset={initialize: function() {
			...
			F.innerHTML=K;
			L.insertBefore(F,L.firstChild);H=F.firstChild,G=H.firstChild,I=H.nextSibling.firstChild.firstChild;
			this.doesNotAddBorder=(G.offsetTop!==5);
			this.doesAddBorderForTableAndCells=(I.offsetTop===5);H.style.overflow="hidden",H.style.position="relative";
